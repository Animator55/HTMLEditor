import { faCircleXmark, faEye, faTrash, faWindowRestore } from "@fortawesome/free-solid-svg-icons";
...
export default function EditorParser({editor, setSelected, selectedFonts, EditorRef, DNone}) {
    ...
    function EditorForm () {
        return editor === "New" || EditorJSON !== undefined ?
        <div>AFisnf</div>
        //  <JsxParser
        //     bindings={{
    ...
    return (
        <div 
            ref={EditorRef}
            className={EditorJSON !== undefined && !DNone ? "component-editor" : "component-editor d-none"} 
        >
            <RefreshButton/>
            <EditorTopBar/>
            <EditorForm />
